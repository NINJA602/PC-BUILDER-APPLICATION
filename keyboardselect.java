...
public class keyboardselect extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					keyboardselect frame = new keyboardselect();
	...
	public keyboardselect() {
		...
		JLabel lblNewLabel = new JLabel("VIEW OR SELECT KEYBOARD");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					ResultSet rs=st.executeQuery("select * from keyboard");
