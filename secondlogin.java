...
public class secondlogin extends JFrame {
	...
	public secondlogin() {
		...
		lblNewLabel.setBounds(470, 10, 266, 67);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("EMAIL");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblNewLabel_1.setBounds(403, 139, 102, 30);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("PASSWORD");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblNewLabel_2.setBounds(403, 219, 78, 19);
		contentPane.add(lblNewLabel_2);
		
		textField = new JTextField();
		textField.setBounds(563, 143, 173, 27);
		contentPane.add(textField);
		textField.setColumns(10);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(563, 216, 173, 30);
		...
		btnNewButton.setBounds(774, 299, 123, 30);
		...
		btnNewButton_1.setBounds(774, 471, 123, 30);
		...
		btnNewButton_2.setBounds(774, 355, 123, 30);
		...
		btnNewButton_3.setBounds(774, 410, 123, 30);
