...
public class headphoneselect extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					headphoneselect frame = new headphoneselect();
	...
	public headphoneselect() {
		...
		JLabel lblNewLabel = new JLabel("VIEW OR SELECT HEADPHONE");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					ResultSet rs=st.executeQuery("select * from headphone");
