...
public class cpuselect extends JFrame {
	...
	public cpuselect() {
		...
		lblNewLabel.setBounds(371, 0, 211, 74);
		...
		btnNewButton.setBounds(733, 103, 85, 21);
		...
		scrollPane.setBounds(25, 147, 806, 329);
		...
		textField.setBounds(25, 486, 228, 41);
		...
		btnNewButton_2.setBounds(168, 543, 85, 21);
		...
		btnNewButton_3.setBounds(287, 506, 108, 21);
		contentPane.add(btnNewButton_3);
		
		JLabel lblNewLabel_1 = new JLabel("BRAND");
		lblNewLabel_1.setBounds(25, 80, 45, 13);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("No. of Cores");
		lblNewLabel_2.setBounds(156, 80, 88, 13);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Price <");
		lblNewLabel_3.setBounds(308, 80, 72, 13);
		contentPane.add(lblNewLabel_3);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(25, 103, 72, 21);
		...
		btnNewButton_4.setBounds(733, 68, 85, 21);
		contentPane.add(btnNewButton_4);
		
		textField_1 = new JTextField();
		textField_1.setBounds(299, 104, 96, 19);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setBounds(157, 104, 96, 19);
