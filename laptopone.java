...
private JTextField textField;
	...
	public laptopone() {
		...
		comboBox.setBounds(40, 143, 80, 37);
		...
		scrollPane.setBounds(40, 219, 847, 330);
		...
		comboBox_1.setBounds(150, 143, 80, 37);
		...
		comboBox_2.setBounds(261, 143, 80, 37);
		...
		comboBox_3.setBounds(371, 143, 80, 37);
		...
		comboBox_4.setBounds(480, 143, 80, 37);
		...
		lblNewLabel.setBounds(40, 93, 87, 23);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("CATEGORY");
		lblNewLabel_1.setBounds(150, 90, 80, 28);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("RAM");
		lblNewLabel_2.setBounds(254, 93, 87, 23);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_4 = new JLabel("PROCESSOR");
		lblNewLabel_4.setBounds(371, 98, 80, 13);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("GPU");
		lblNewLabel_5.setBounds(480, 98, 45, 13);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("PRICE < ");
		lblNewLabel_6.setBounds(594, 98, 63, 13);
		...
		btnNewButton.setBounds(767, 158, 120, 37);
		...
		btnNewButton_1.setBounds(767, 111, 120, 37);
		contentPane.add(btnNewButton_1);
		
		JLabel lblNewLabel_3 = new JLabel("FILTER");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_3.setBounds(388, 10, 127, 55);
		contentPane.add(lblNewLabel_3);
		
		textField = new JTextField();
		textField.setBounds(588, 143, 96, 37);
