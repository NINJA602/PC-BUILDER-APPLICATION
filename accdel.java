...
public class accdel extends JFrame {
	...
	public accdel() {
		...
		JLabel lblNewLabel = new JLabel("ACC. DELETE");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel.setBounds(404, 10, 145, 56);
		contentPane.add(lblNewLabel);
		
		textField = new JTextField();
		textField.setBounds(297, 90, 283, 34);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Enter email of acc. to be deleted");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblNewLabel_1.setBounds(52, 95, 234, 23);
		contentPane.add(lblNewLabel_1);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(297, 164, 283, 34);
		contentPane.add(passwordField);
		
		JLabel lblNewLabel_2 = new JLabel("Enter password");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblNewLabel_2.setBounds(166, 172, 143, 26);
		...
		btnNewButton.setBounds(450, 274, 130, 26);
