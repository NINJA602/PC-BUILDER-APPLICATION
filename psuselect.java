...
public class psuselect extends JFrame {
	...
	public psuselect() {
		...
		JLabel lblNewLabel = new JLabel("VIEW OR SELECT PSU");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					ResultSet rs=st.executeQuery("select * from psu");
