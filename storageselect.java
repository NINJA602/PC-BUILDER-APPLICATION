...
public class storageselect extends JFrame {
	...
	public storageselect() {
		...
		lblNewLabel.setBounds(271, 0, 258, 74);
		...
		btnNewButton.setBounds(733, 94, 85, 21);
		...
		scrollPane.setBounds(25, 138, 806, 329);
		...
		btnNewButton_3.setBounds(290, 506, 108, 21);
		contentPane.add(btnNewButton_3);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(25, 94, 96, 21);
		...
		comboBox_1.setBounds(168, 94, 85, 21);
		...
		comboBox_2.setBounds(300, 94, 77, 21);
		contentPane.add(comboBox_2);
		comboBox_2.addItem("");
		comboBox_2.addItem("<1 TB");
		comboBox_2.addItem("1 TB");
		comboBox_2.addItem("2 TB");
		
		JLabel lblNewLabel_1 = new JLabel("BRAND");
		lblNewLabel_1.setBounds(21, 68, 45, 13);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("TYPE");
		lblNewLabel_2.setBounds(168, 68, 45, 13);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("CAPACITY");
		lblNewLabel_3.setBounds(300, 72, 77, 13);
		...
		btnNewButton_4.setBounds(733, 63, 85, 21);
