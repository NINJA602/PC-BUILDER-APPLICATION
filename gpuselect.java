...
public class gpuselect extends JFrame {
	...
	public gpuselect() {
		...
		lblNewLabel.setBounds(357, -16, 211, 74);
		...
		btnNewButton_1.setBounds(733, 28, 85, 21);
		...
		btnNewButton_3.setBounds(286, 496, 108, 21);
		contentPane.add(btnNewButton_3);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(68, 82, 101, 27);
		...
		comboBox_1.setBounds(201, 82, 85, 27);
		...
		lblNewLabel_1.setBounds(71, 59, 45, 13);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("MEMORY");
		lblNewLabel_2.setBounds(201, 59, 68, 13);
		contentPane.add(lblNewLabel_2);
		
		textField_1 = new JTextField();
		textField_1.setBounds(321, 82, 108, 27);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("PRICE <");
		lblNewLabel_3.setBounds(321, 59, 73, 13);
