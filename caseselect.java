...
public class caseselect extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					caseselect frame = new caseselect();
	...
	public caseselect() {
		...
		JLabel lblNewLabel = new JLabel("VIEW OR SELECT CPU CASE");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					ResultSet rs=st.executeQuery("select * from cabinet");
