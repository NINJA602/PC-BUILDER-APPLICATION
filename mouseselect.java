...
public class mouseselect extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					mouseselect frame = new mouseselect();
	...
	public mouseselect() {
		...
		JLabel lblNewLabel = new JLabel("VIEW OR SELECT MOUSE");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					ResultSet rs=st.executeQuery("select * from mouse");
